...
try:
        ...
        cetak(nel('\x1b[38;5;231m• \x1b[38;5;46mSedang Menginstall Modul Rich \x1b[38;5;231m•'))
        os.system('pip install rich')
try:
        import stdiomask
except ImportError:
        cetak(nel('\x1b[38;5;231m• \x1b[38;5;46mSedang Menginstall Modul Stdiomask \x1b[38;5;231m•'))
        os.system('pip install stdiomask')
try:
	import requests
except ImportError:
	cetak(nel('\x1b[38;5;231m• \x1b[38;5;46mSedang Menginstall Modul Requests \x1b[38;5;231m•'))
	os.system('pip install requests && pip install mechanize ')

try:
	import screenfetch
except ImportError:
	cetak(nel('\x1b[38;5;231m• \x1b[38;5;46mSedang COLI\x1b[38;5;231m•'))
...
os.system('clear')
print('''
\33[1;96m╦  ┬┌─┐┌─┐┌┐┌┌─┐┬ \x1b[38;5;231mCODE BY : \x1b[1;92m🅳🅷🅰🅼🆂🅲🆈🅱🅴🆁
\33[1;96m║  │└─┐├┤ │││└─┐│ \x1b[38;5;231mTEAM :🆃🅰🅽🅶🅴🆁🅰🅽🅶404
\33[1;96m╩═╝┴└─┘└─┘┘└┘└─┘┴ \x1b[38;5;231mWANGSAFF : 083835332282
    ''''')
lesensi = input('\x1b[38;5;231mPESAN SAYA  : Coli Dulu Deck')




if lesensi not in '𝕯𝖍𝖆𝖒𝕮𝖞𝖇𝖊𝖗':
    print ('\x1b[1;91mLISENSI IN VALID')
if lesensi == '𝕯𝖍𝖆𝖒𝕮𝖞𝖇𝖊𝖗':
...
def menu(my_name,my_id):
	...
	cetak(nel('\x1b[38;5;231m▁ ▂ ▄ ▅ ▆ ▇ █   🎀  𝒮𝑒𝓁𝒶𝓂𝒶𝓉 𝒹𝒶𝓉𝒶𝓃𝑔  🎀   █ ▇ ▆ ▅ ▄ ▂ ▁ [yellow]%s \x1b[38;5;208mNgentod'%(my_name)))
	print(f'[\x1b[38;5;226mID] \x1b[38;5;208mID Kamu :\x1b[38;5;46m '+str(my_id))
	print(f'[\x1b[38;5;226mIP] \x1b[38;5;208mIP Kamu  :\x1b[38;5;46m {ip}')
...
def dump_massal():
	try:
		...
		exit()
	try:
		jum = int(input('\x1b[38;5;196m=\x1b[38;5;231m=\x1b[38;5;44m=> \x1b[38;5;231mMau Berapa Target Cok ? : '))
	except ValueError:
...
#			id2.insert(xx,bacot)
	...
	if hc in ['1','01']:
		...
		print('[😏] \x1b[38;5;226mPilih Yang Bener anjing ')
		setting()
	elif hc in ['2','02']:
		method.append('free')
	elif hc in ['3','03']:
...
#-------------------[ BAGIAN-WORDLIST ]------------#
def passwrd():
	print(f'>>>>> {m}•{k}•{h}•{x} \x1b[38;5;231mSedang CoLi \x1b[38;5;46mMohon Bersabar  {m}•{k}•{h}•{x} <<<<< ')
	print('')
	print(f'[😁] Hasil {h}OK{x} Tersimpan Di : {h}OK/%s {x}'%(okc))
	print(f'[😁] Hasil {k}CP{x} Tersimpan Di : {k}CP/%s {x}'%(cpc))
	print(f'[✈] Mainkan Mode Pesawat Setiap {m}1000{x} Idz\n')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r 𝓨𝓷𝓷𝓭❃{P}[{b}{loop}{P}/{u}{len(id)}{P}]—{P}[{H}{ok}{P}]—{P}[{k}{cp}{x}]—[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
	sys.stdout.flush()
